...
## Transfer a group to new user

**URL Structure**

> **\[PUT]** /api/v2.1/org/`<org_id>`/admin/groups/`<group_id>`/
...
> curl --request PUT \
> --header 'Authorization: Token b6720d34395851f7bada7d86d8f121936b727391' \
> "https://cloud.seatable.io/api/v2.1/org/45/admin/groups/45/" 
> -F new_owner=c7b0e3215c2347c196e761a41be031e4@auth.local
>
> ```
...
> {
>     "id": 45,
>     "group_name": "transfer-group1",
>     "ctime": "2021-01-11T01:32:36+00:00",
>     "creator_email": "c7b0e3215c2347c196e761a41be031e4@auth.local",
>     "creator_name": "user3",
>     "creator_contact_email": "delete_user3@qq.com"
> }
>
> ```
>
